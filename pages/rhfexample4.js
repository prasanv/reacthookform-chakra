    ...
    <Home></Home>
      <form className={styles.controlledMain}>
        <Controller
          name="firstname"
          control={control}
          render={({ field }) => <Input id='firstname' placeholder="First Name" w="300px" m={2} {...field} />}
        />
        {errors.firstname && <span className={styles.errorMsg}>Invalid first Name</span>}
        <Controller
          name="lastname"
          control={control}
          render={({ field }) => <Input id='lastname' placeholder="Last Name" w="300px" m={2} {...field} />}
        />
        {errors.lastname && <span className={styles.errorMsg}>Invalid Last Name</span>}
        <Controller
          name="email"
          control={control}
          render={({ field }) => <Input id='email' placeholder="Email Address" w="300px" m={2} {...field} />}
        />
